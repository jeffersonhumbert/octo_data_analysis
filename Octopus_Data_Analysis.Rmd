...
```{r}
events$realtime[events$Species=="octopus_rubescens"&events$Behavior=="frame_arrival"]
events$realtime[events$Species=="octopus_rubescens"&events$Behavior=="frame_departure"]
```
