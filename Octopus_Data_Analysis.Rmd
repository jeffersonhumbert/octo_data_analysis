...
```{r}
octo.tab=
  as.vector(table(octo.visit$resident,octo.visit$daynight))
```
...
octo.probs=
  c(
    c(min.res.absent/(min.res.absent+min.res.present),min.res.present/(min.res.absent+min.res.present))*mean(octo.visit$day_expected),
    c(min.res.absent/(min.res.absent+min.res.present),min.res.present/(min.res.absent+min.res.present))*(1-mean(octo.visit$day_expected))
  )
```
