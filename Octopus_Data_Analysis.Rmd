...
Assumptions fail, so I am using a permutation two-sample test.
```{r rockfish permTS}
permTS(rock.visit$duration[rock.visit$octopus=="absent"],rock.visit$duration[rock.visit$octopus=="present"],
       alternative="two.sided",method="exact.mc",control=permControl(nmc=10000))
...
text(1.5,exp(log(max(ling.visit$duration))+1),paste("p=",signif(ling.permTS$p.value,1),sep=""))
