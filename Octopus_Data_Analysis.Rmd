...
mtext("fortify",side=3,line=1.5,cex=1.5)
mtext(paste("n=",length(events$realtime[events$Species=="octopus_rubescens"&events$Behavior=="fortify"]),sep=""),
...
rasterImage(moon,-0.15,0.6,0.15,0.9)
rasterImage(sun,-0.15,-0.6,0.15,-0.9)
mtext("departures",side=3,line=1,cex=1.5)
...
rasterImage(moon,-0.15,0.6,0.15,0.9)
rasterImage(sun,-0.15,-0.6,0.15,-0.9)
mtext("periscope",side=3,line=1,cex=1.5)
...
rasterImage(moon,-0.15,0.6,0.15,0.9)
rasterImage(sun,-0.15,-0.6,0.15,-0.9)
mtext("enter/exit bottle",side=3,line=1,cex=1.5)
dev.off()
```
